...
WorkspacePath          := "/project/c/erasure_code/rozofs-1.0.0"
ProjectPath            := "/project/c/test"
...
$(IntermediateDirectory)/main$(ObjectSuffix): main.c $(IntermediateDirectory)/main$(DependSuffix)
	$(CC) $(SourceSwitch) "/project/c/test/main.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/main$(ObjectSuffix) $(IncludePath)
...
clean:
	...
	$(RM) $(OutputFile)
	$(RM) "../erasure_code/rozofs-1.0.0/.build-debug/test"
